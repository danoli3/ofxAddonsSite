...
<p>Signing in only ever asks GitHub for your public profile (username and avatar), to match you to the repos the crawler already found under your account. It doesn't request any repository access at all &mdash; not your private repos, not the ability to read your code, not push access, nothing. We also never see or store your GitHub password.</p>
